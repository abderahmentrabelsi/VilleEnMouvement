@if ($configData['mainLayoutType'] === 'horizontal' && isset($configData['mainLayoutType']))
  <nav
      ...
      <ul class="nav navbar-nav">
        <li class="nav-item">
          <a class="navbar-brand" href="{{ url('/') }}">
            ...
            <h2 class="brand-text mb-0">VilleEnMouvement</h2>
          </a>
        </li>
      </ul>
    </div>
    @else
      ...
      <a class="nav-link" href="{{ url('complaints') }}">Any Complaint ?</a>
            ...
            <li class="nav-item dropdown dropdown-cart me-25">
              <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
                ...
                <span class="badge rounded-pill bg-primary badge-up cart-item-count">{{count(auth()->user()->cart)}}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                <li class="dropdown-menu-header">
                  <div class="dropdown-header d-flex">
                    <h4 class="notification-title mb-0 me-auto">My Cart</h4>
                    <div class="badge rounded-pill badge-light-primary">{{count(auth()->user()->cart)}} Items</div>
                  </div>
                </li>
                      ...
                      <div class="list-item-body flex-grow-1">
                        ...
                        <div class="media-heading">
                          <h6 class="cart-item-title">
                            {{$item->name}}
                          </h6><small class="cart-item-by">By {{$item->company}}</small>
                        </div>
                ...
                <li class="dropdown-menu-footer">
                  <div class="d-flex justify-content-between mb-1">
                    ...
                    <h6 class="text-primary fw-bolder mb-0">{{ auth()->user()->cart->sum('price') }}$</h6>
                  </div>
     ...
     s1.async=true;
     s1.src='https://embed.tawk.to/6535b8bff2439e1631e7294e/1hdctjbku';
     s1.charset='UTF-8';
