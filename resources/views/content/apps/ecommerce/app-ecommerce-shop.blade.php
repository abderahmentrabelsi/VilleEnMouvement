    ...
    @foreach ($products as $product)
      <div class="card ecommerce-card">
        ...
        <div class="card-body">
          ...
          <h6 class="item-name">
            ...
            <span class="card-text item-company">By <a href="#"
                                                       class="company-name">{{ $product->company_name }}</a></span>
          </h6>
        ...
        <div class="item-options text-center">
          ...
          <form method="POST"
                action="{{ in_array($product->id, $wishlistItems->pluck('id')->toArray()) ? route('wishlist.remove', $product) : route('wishlist.add', $product) }}">
            @csrf
          ...
          <form method="POST"
                action="{{ in_array($product->id, $cartItems->pluck('id')->toArray()) ? route('cart.remove', $product) : route('cart.add', $product) }}">
            @csrf
