        ...
        <div id="place-order" class="list-view product-checkout">
          ...
          <div class="checkout-items">
            <div class="card ecommerce-card">
              ...
              <div class="card-body">
                <div class="item-name">
                  <h6 class="mb-0"><a href="{{url('app/ecommerce/details')}}" class="text-body">Apple
                      Watch Series 5</a>
                  </h6>
            ...
            <div class="card ecommerce-card">
              ...
              <div class="card-body">
                <div class="item-name">
                  <h6 class="mb-0">
                    <a href="{{url('app/ecommerce/details')}}" class="text-body">Apple iPhone 11
                      (64GB, Black)</a>
                  </h6>
                  <span class="item-company">By <a href="#" class="company-name">Apple</a></span>
                  <div class="item-rating">
            ...
            <div class="card ecommerce-card">
              ...
              <div class="card-body">
                <div class="item-name">
                  <h6 class="mb-0">
                    <a href="{{url('app/ecommerce/details')}}" class="text-body">OneOdio A71 Wired
                      Headphones</a>
                  </h6>
            ...
            <div class="card ecommerce-card">
              ...
              <div class="card-body">
                <div class="item-name">
                  <h6 class="mb-0">
                    <a href="{{url('app/ecommerce/details')}}" class="text-body">Switch Pro
                      Controller </a>
                  </h6>
          ...
          <div class="payment-type">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="{{route("start-checkout-session")}}" method="POST">
                  <div class="d-flex flex-row gap-2">
                    @csrf
                    <label for="discount-code">Promo Code</label>
                    <input type="text" class="form-control mb-50" style="max-width: 100px; " name="discount-code"
                           id="discount-code"/>

                    <button type="submit" class="btn btn-primary btn-cvv mb-50">Continue with Stripe
                    </button>
                  </div>
                </form>
                <hr class="my-2"/>
